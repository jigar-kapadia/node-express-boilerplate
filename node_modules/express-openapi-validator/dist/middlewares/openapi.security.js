...
function security(context, securityHandlers) {
    return async (req, res, next) => {
        ...
        const securities = (_a = req.openapi.schema.security, (_a !== null && _a !== void 0 ? _a : context.apiDoc.security));
        ...
        try {
            ...
            const message = ((_d = (_c = e) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.message) || 'unauthorized';
    ...
    async executeHandlers(req) {
        ...
        const promises = this.securities.map(async (s) => {
            ...
            try {
                ...
                const handler = (_b = (_a = this.securityHandlers) === null || _a === void 0 ? void 0 : _a[securityKey], (_b !== null && _b !== void 0 ? _b : fallbackHandler));
                ...
                return {
                    success: false,
                    status: (_c = e.status, (_c !== null && _c !== void 0 ? _c : 401)),
                    error: e,
                };
            }
        });
